...
function mountAccountHistoryRecovery(host,section){if(!document.getElementById("mk-account-history-recovery-style")){const style=el("style");style.id="mk-account-history-recovery-style";style.textContent=`
