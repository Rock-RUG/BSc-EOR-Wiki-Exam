...
function crSvg(name,size){const s=Number(size)||18;const icons={"check-decagram-outline":'<path d="M3.85 8.62a4 4 0 0 1 4.78-4.77 4 4 0 0 1 6.74 0 4 4 0 0 1 4.78 4.78 4 4 0 0 1 0 6.74 4 4 0 0 1-4.77 4.78 4 4 0 0 1-6.75 0 4 4 0 0 1-4.78-4.77 4 4 0 0 1 0-6.76Z"/><path d="m9 12 2 2 4-4"/>',"shield-check-outline":'<path d="M20 13c0 5-3.5 7.5-7.66 8.95a1 1 0 0 1-.67-.01C7.5 20.5 4 18 4 13V6a1 1 0 0 1 1-1c2 0 4.5-1.2 6.24-2.72a1.17 1.17 0 0 1 1.52 0C14.51 3.81 17 5 19 5a1 1 0 0 1 1 1z"/><path d="m9 12 2 2 4-4"/>',"check-circle-outline":'<circle cx="12" cy="12" r="10"/><path d="m9 12 2 2 4-4"/>',"help-circle-outline":'<circle cx="12" cy="12" r="10"/><path d="M9.09 9a3 3 0 0 1 5.83 1c0 2-3 3-3 3"/><path d="M12 17h.01"/>',"close-circle-outline":'<circle cx="12" cy="12" r="10"/><path d="m15 9-6 6"/><path d="m9 9 6 6"/>',"exit-to-app-outline":'<path d="M15 3h4a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2h-4"/><path d="m10 17 5-5-5-5"/><path d="M15 12H3"/>',"file-edit-outline":'<path d="M12.5 22H18a2 2 0 0 0 2-2V7l-5-5H6a2 2 0 0 0-2 2v9.5"/><path d="M14 2v4a2 2 0 0 0 2 2h4"/><path d="M13.38 15.63a1 1 0 1 0-3-3l-5.01 5.01a2 2 0 0 0-.51.85l-.84 2.87a.5.5 0 0 0 .62.62l2.87-.84a2 2 0 0 0 .85-.51z"/>',};if(!icons[name])return"";return`<svg width="${s}" height="${s}" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" focusable="false">${icons[name]}</svg>`;}
...
function mLabel(m){if(m===3)return"Mastered";if(m===2)return"Clear";if(m===1)return"Partial";if(m===0)return"Unknown";return"";}
        ...
        <tr style="border-bottom:1px solid var(--md-default-fg-color--lightest);">
          ...
          <td style="padding:10px;">
            <select class="cm-level" data-id="${id}" style="padding:4px 8px;border-radius:10px;">
              ...
              <option value="3" ${cur===3 ? "selected":""}>Mastered</option>
              <option value="2" ${cur===2 ? "selected":""}>Clear</option>
              <option value="1" ${cur===1 ? "selected":""}>Partial</option>
