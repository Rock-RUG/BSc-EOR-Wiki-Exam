...
const fit=modal.querySelector('[data-lp-map-fit]');if(fit)fit.setAttribute('aria-label',hasPath?'Fit selected learning path in view':'Fit all map nodes in view');}
      ...
      <div class="lp-mbox" role="dialog" aria-modal="true" aria-label="Concept maps">
        ...
        <div class="lp-map-topbar">
          ...
          <div class="lp-map-context">
            <button class="lp-btn lp-map-fit" type="button" data-lp-map-fit aria-label="Fit all map nodes in view">Fit view</button>
