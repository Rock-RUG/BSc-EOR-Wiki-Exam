...
e.stopPropagation();},{passive:true});const __lpEndZoomDrag=(e)=>{if(e&&e.type==="change"&&__lpZoomPointerHeld)return;__lpZoomPointerHeld=false;lpMarkLocalMapInteractionBusy(180);if(__lpZoomInputRaf){try{cancelAnimationFrame(__lpZoomInputRaf);}catch(_){}
