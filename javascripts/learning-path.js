...
function schedulePreviewLeave(){cancelPreviewLeave();leaveTimer=window.setTimeout(()=>{leaveTimer=0;if(st2.__lpRenderId!==renderId)return;clearFocus();},180);}
