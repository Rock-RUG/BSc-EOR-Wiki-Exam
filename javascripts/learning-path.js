...
if(parchmentRim)(land||layer).appendChild(parchmentRim);borderPaint.forEach(border=>(land||layer).appendChild(border));const labelTarget=paintOptions.labels||layer;labelPaint.forEach(label=>labelTarget.appendChild(label));svg.insertBefore(layer,svg.firstChild);return layer;}
