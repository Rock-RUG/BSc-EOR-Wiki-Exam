...
function mLabel(m){if(m===3)return"Mastered";if(m===2)return"Clear";if(m===1)return"Partial";if(m===0)return"Unknown";return"Not rated";}
        ...
        <div class="mm-card-line">
          ...
          <div class="mm-level-cell">
            ...
            <select data-loc="${escapeHtml(item.loc)}" class="mm-level mm-select" aria-label="Mastery level for ${escapeHtml(item.title || item.loc)}">
              ...
              <option value="1" ${item.m === 1 ? "selected" : ""}>Partial</option>
