...
if(accountFeatureEnabled()){const activityItems=[{label:"Continue learning",action:"section"},{label:"Resume review",sitePath:"find.html#study-session"},{label:"Study sets",sitePath:"find.html#study-sets"},{label:"Saved Pages",action:"local-activity",kind:"saved"},{label:"Activity",action:"local-activity",kind:"activity"},{label:"Account & privacy",action:"section"},{label:"Account",action:"local-activity",kind:"info"},{label:"Learning data & backups",sitePath:"about.html#learning-data-backups"},{label:"My public profile",action:"local-activity",kind:"public-profile"},{label:"Edit profile",action:"local-activity",kind:"edit-profile"},{label:"Privacy",action:"local-activity",kind:"privacy"},{label:"Connect & collect",action:"section"},{label:"Notifications",action:"local-activity",kind:"notifications"},{label:"Connections",action:"local-activity",kind:"connections"},{label:"My collection",action:"local-activity",kind:"rewards"},{label:"Arena & weekend events",action:"local-activity",kind:"arena"},{label:"Store",action:"local-activity",kind:"shop"},];const activityPanel=ensurePanel(IDS.activityPanel);fillPanel(activityPanel,activityItems);const activityBtn=makeTrigger("My",IDS.activityPanel);activityBtn.dataset.mkLocalKind="my";{const lab=activityBtn.querySelector('.mk-rt-label')||activityBtn;lab.insertAdjacentHTML("beforeend",'<span class="mk-rt-badge mk-rt-account-badge" data-mk-rt-account-badge>1</span><span class="mk-rt-badge mk-rt-notification-badge mk-rt-notification-badge--trigger" data-mk-rt-notification-badge hidden>0</span><span class="mk-rt-badge mk-rt-shop-discount-badge mk-rt-shop-discount-badge--trigger" data-mk-shop-discount-badge hidden>1</span>');}
