...
function rankingsItems(trendingHref){const items=[{label:"Most Viewed",href:makeTrendingMetricHref(trendingHref,"views"),noActive:true},{label:"Most Popular",href:makeTrendingMetricHref(trendingHref,"popular"),noActive:true},{label:"Most Tested",href:makeTrendingMetricHref(trendingHref,"tested"),noActive:true},];if(accountFeatureEnabled()){items.push({label:"Biggest Spenders",href:makeTrendingMetricHref(trendingHref,"spenders"),noActive:true},{label:"EOR Rating",href:makeTrendingMetricHref(trendingHref,"eor_rating"),noActive:true},{label:"Most Active Users",href:makeTrendingMetricHref(trendingHref,"users"),noActive:true},{label:"AI Quiz Lovers",href:makeTrendingMetricHref(trendingHref,"quiz_correct"),noActive:true},);}
return items;}
