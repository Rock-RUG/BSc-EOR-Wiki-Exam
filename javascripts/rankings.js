...
if(metricNote){const details=el("details","trending-metric-details");details.appendChild(el("summary","","How it counts"));details.appendChild(el("p","trending-user-ranking-note",metricNote));boardMeta.appendChild(details);}
