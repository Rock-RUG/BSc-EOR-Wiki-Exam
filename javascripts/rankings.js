...
return{items:data.entries,total:data.total,firstEligibleMonth:/^\d{4}-(0[1-9]|1[0-2])$/.test(String(data.firstEligibleMonth||""))?data.firstEligibleMonth:"",graceHours:Number.isFinite(data.graceHours)&&data.graceHours>=0?data.graceHours:null,fetchedAt:Date.now(),};}
