...
if(metric==="quiz_correct"){block.appendChild(el("p","trending-user-ranking-note","Correct and wrong answer counts from public learning activity. These are practice counts, not an accuracy ranking or a measure of academic ability."));}
