...
function hideDropdown(input){const host=getOverlayContainer(input);const root=host&&host.querySelector(`.${ROOT_CLASS}`)?ensureDropdown(input):null;if(root){root.style.display="none";try{root.setAttribute("aria-hidden","true");}catch(_){}}
