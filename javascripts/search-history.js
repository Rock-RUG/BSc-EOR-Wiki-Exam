...
hideDropdown(input);},80);});input.addEventListener("keydown",(ev)=>{const root=ensureDropdown(input);const dropdownVisible=root&&root.style.display!=="none";if(!dropdownVisible){if(ev.key==="Escape")hideDropdown(input);return;}
